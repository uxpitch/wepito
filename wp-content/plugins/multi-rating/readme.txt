...
A powerful post rating / review system plugin for WordPress with a niche of doing multi ratings better than anyone else. Can also be used for polls, quizzes, online voting and surveys.
...
* Show a breakdown of rating items in a poll / bar chart layout (e.g. Amazon style ratings)
