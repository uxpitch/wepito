<div class="wrap">
	...
	<div id="poststuf">
		...
		<div id="post-body" class="metabox-holder columns-2">
			...
			<div id="post-body-content" style="float:none;display: inline-block;width: 73%;vertical-align:top;margin:0">
				...
				<div class="map-wrapper">
					<a href="#" id="map-change" class="tsort-change" style="writing-mode: inherit;color:red">Change Image</a>
				...
				<div class="clear"></div>
				<div class="items" style="    border-top: 1px solid gray;">
				...
				<div class="imapper_items_options" style="border-top: 1px solid gray;">
			...
			<div id="postbox-container-1" class="postbox-container" style="float:none;display: inline-block;width: 26%;margin:0">
				<div class="postbox">
